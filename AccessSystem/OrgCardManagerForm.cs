...
{
    public partial class OrgCardManagerForm : Form
    {
        /// <summary>
        /// Gloal Variables.
        /// </summary>
        ...
        /// Form Shown Event.
        /// </summary>
        private void OrgCardManagerForm_Shown(object sender, EventArgs e) {
            try {
                ...
                var result = Common.ShowWait(() => {
                    ...
                    Cards = CardEntity.GetOrgCards(Common.CurUser.Role.RoleID);
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.OrgCardManagerForm.Shown", err.Message, err.StackTrace);
        ...
        private void EmpTreeView_AfterSelect(object sender, TreeViewEventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.OrgCardManagerForm.EmpTreeView.AfterSelect", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void SubCardCB_CheckedChanged(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.OrgCardManagerForm.SubCardCB.CheckedChanged", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void BatchAddBtn_Click(object sender, EventArgs e) {
            try {
                if (new BatchOrgCardsForm().ShowDialog(this) == System.Windows.Forms.DialogResult.OK) {
                    Cards = CardEntity.GetOrgCards(Common.CurUser.Role.RoleID);
                    BindCardsToGridView();
                }
            } catch (Exception err) {
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.OrgCardManagerForm.BatchAddBtn.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
            ...
            try {
                ...
                if (Dialog.ShowDialog(this) == System.Windows.Forms.DialogResult.OK) {
                    ...
                    if (FindCard != null) {
                        ...
                        var TreeNode = EmpTreeView.Nodes.Find(String.Format("delta_employee_{0}", FindCard.WorkerId), true);
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.OrgCardManagerForm.FindCardBtn.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void OperationContext_Opening(object sender, CancelEventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.OrgCardManagerForm.OperationContext.Opening", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void TVToolStripMenuItem1_Click(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.OrgCardManagerForm.TVToolStripMenuItem1.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
