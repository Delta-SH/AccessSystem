...
{
    public partial class BatchOrgCardsForm : Form
    {
        /// <summary>
        /// Gloal Variables.
        /// </summary>
        ...
        private List<IDValuePair<CardInfo, OrgEmployeeInfo>> Cards;

        /// <summary>
        /// Class Constructor
        /// </summary>
        public BatchOrgCardsForm() {
            InitializeComponent();
            CardEntity = new Card();
            Employees = new List<OrgEmployeeInfo>();
            ExistCards = new Dictionary<String, CardInfo>();
            Cards = new List<IDValuePair<CardInfo, OrgEmployeeInfo>>();
        }

        /// <summary>
        /// Form Load Event.
        /// </summary>
        private void BatchOrgCardsForm_Load(object sender, EventArgs e) {
            try {
                BindCardTypeCombobox();
                BindCardReasonCombobox();
                CardTypeCB.SelectedValue = (Int32)EnmCardType.ZSK;
                BeginTimeDTP.Value = DateTime.Now;
            } catch (Exception err) {
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.Load", err.Message, err.StackTrace);
        ...
        private void SetEmpBtn_Click(object sender, EventArgs e) {
            try {
                var Dialog = new OrgEmployeeDialog(true);
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.SetEmpBtn.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void EmpGridView_CellValueNeeded(object sender, DataGridViewCellValueEventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.EmpGridView.CellValueNeeded", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void OperationContext_Opening(object sender, CancelEventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.OperationContext.Opening", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void OpMenuItem1_Click(object sender, EventArgs e) {
            try {
                if (EmpGridView.SelectedRows.Count > 0) {
                    ...
                    if (adEmps.Count > 0) {
                        if (MessageBox.Show("选中员工将被移除，您确定要移除吗？", "确认对话框", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.OK) {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.OpMenuItem1.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void OpMenuItem2_Click(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.OpMenuItem2.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void BeginReasonCB_SelectedIndexChanged(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.BeginReasonCB.SelectedIndexChanged", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void CardIDTB_TextChanged(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.CardIDTB.TextChanged", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            } finally {
                CardXIDTB.TextChanged += CardXIDTB_TextChanged;
            }
        ...
        private void CardXIDTB_KeyDown(object sender, KeyEventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.CardXIDTB.KeyDown", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void ReadCard() {
            ...
            if (obj == null) {
                MessageBox.Show(String.Format("未查询到员工信息[工号: {0}]", key), "系统警告", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            Cards.Add(new IDValuePair<CardInfo, OrgEmployeeInfo>(card, obj));
            BindCardsToGridView();
        ...
        private void SignToolStripMenuItem1_Click(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.SignToolStripMenuItem1.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void SignToolStripMenuItem2_Click(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.BatchOrgCardsForm.SignToolStripMenuItem2.Click", err.Message, err.StackTrace);
                MessageBox.Show(err.Message, "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
