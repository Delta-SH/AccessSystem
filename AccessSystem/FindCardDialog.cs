...
{
    public partial class FindCardDialog : Form
    {
        /// <summary>
        /// XCardSn
        /// </summary>
        ...
        private void CardSnTB_TextChanged(object sender, EventArgs e) {
            try {
                ...
                Common.WriteLog(DateTime.Now, EnmMsgType.Error, "System", "Delta.MPS.AccessSystem.FindCardDialog.CardIDTB.TextChanged", err.Message, err.StackTrace);
